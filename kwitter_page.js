...
message = "<p>"+msg+"</p>";
likes = "<button class='btn btn-warning glyphicon glyphicon-thumbs-up' onclick='likess(this.id)' id='"+firebase_message_id+"value = "+like+"'>Like</button><p id='liking'></p>";
...
console.log(like);
like_s = document.getElementById("like_count").value;
like = Number(like_s) + 1;
//document.getElementById("liking").innerHTML = like;
firebase.database().ref(room_name).child(like_count).update({
      like:like
});
}
